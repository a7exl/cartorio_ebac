...
int main()
{
	...
	{ do
		{
			...
			{ 
				...
				case 4:
					printf("Obrigado por o usar o nosso sistema. Até logo!");//msg ao usuário
					return 0;//execução da função
					break;//fim do laço de repetição
					//fim da seleção
	...
	{
		printf("Senha incorreta! Verifique e tente novamente.");//condição 
	}
